...
# guests = YAML.load_file("/Users/Admin/Documents/vagrant-first/vagrant-project/vm_machines.yaml")
...
def run_scripts(guest, guest_vm)
	unless guest['scripts'].nil?
		guest['scripts'].each do |script|
			guest_vm.vm.provision "shell", privileged: false, path: "/Users/Admin/Documents/vagrant-first/vagrant-project/vagrant_scripts/#{script}"
		end
	end
end
...
def set_synced_folders(guest, guest_vm)
  ...
  # SHELL
#end
>>>>>>> 7512b0610b09eb1d01dea70303eda3fe3f838004
